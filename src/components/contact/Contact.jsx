...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_r13e8ck', 'template_ljz7seh', form.current, '1RB9PNhiNjau5wZi0Qrzf')
      .then((result) => {
      ...
      <div className="container contact__container">
        <div className="contact__options">
          ...
          <article className='contact__option'>
            ...
            <h4>Twitter</h4>
            <h5>@Atabs09</h5>
            <a href="https://twitter.com/Atabs09" target='_blank'>Send a message</a>{/*"https://web.whatsapp.com//send?phone+905526474074" */}  {/*"https://api.whatsapp.com/send?phone+905526474074" */}
          </article>
        </div>
        {/*End of Contact*/}
        <form ref={form} onSubmit={sendEmail}>                                                                {/*emailjs.com ---> react emailjs ---> npm install emailjs-com--save */}
          ...
          <button type='submit' className='btn btn-primary'>Coming soon</button>
        </form>
      </div>
    </section>
  )
